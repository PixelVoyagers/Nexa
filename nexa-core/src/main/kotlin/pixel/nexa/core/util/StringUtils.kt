...
object StringUtils {
    ...
    fun toSmallUpNumbers(string: String) =
        string.map { SMALL_UP_NUMBERS.getOrNull(it.toString().toInt())?.toString() ?: it }.joinToString("")

    fun toSmallDownNumbers(string: String) =
        string.map { SMALL_DOWN_NUMBERS.getOrNull(it.toString().toInt())?.toString() ?: it }.joinToString("")
